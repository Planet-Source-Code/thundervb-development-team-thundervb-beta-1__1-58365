...
Begin VB.Form frmSettings 
   ...
   Begin TabDlg.SSTab sstSet 
      ...
      Tab(0).Control(0)=   "General_LoadOnStartUp"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "General_SetTopMost"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "General_ListForAllMod"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "General_HookCompiler"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "General_UnLoadNotExe"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "General_PopUpWindow"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "General_SaveOBJ"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "General_AddTLB"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "General_HideErrorDialogs"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "General_AddToMenu"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "General_LogThunVBTools"
      ...
      Tab(2).Control(8)=   "Packer_Desc2"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "Packer_Desc3"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "optPacker_1"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "optPacker_2"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "optPacker_3"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Packer_ShowPackerOutPut"
      ...
      Tab(3).Control(2)=   "cmdColor_DefaultASM"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "ASM_ASMColors"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "cmdColor_AddASM"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "cmdColor_DeleteASM"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "ASM_FixASMListings"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "ASM_CompileASMCode"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).ControlCount=   8
      TabCaption(4)   =   "Debug"
      TabPicture(4)   =   "frmSettings.frx":0070
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Debug_DebMsgBox"
      Tab(4).Control(0).Enabled=   0   'False
      Tab(4).Control(1)=   "Debug_OutDebLog"
      Tab(4).Control(1).Enabled=   0   'False
      Tab(4).Control(2)=   "Debug_DelDebBefCom"
      Tab(4).Control(2).Enabled=   0   'False
      Tab(4).Control(3)=   "Debug_OutAsmToLog"
      Tab(4).Control(3).Enabled=   0   'False
      Tab(4).Control(4)=   "Debug_OutMapFiles"
      Tab(4).Control(4).Enabled=   0   'False
      Tab(4).Control(5)=   "Debug_ForceLog"
      Tab(4).Control(5).Enabled=   0   'False
      Tab(4).Control(6)=   "fraDebug_Frame1"
      Tab(4).Control(6).Enabled=   0   'False
      Tab(4).Control(7)=   "cmdDebug_DeleteAllFiles(0)"
      Tab(4).Control(7).Enabled=   0   'False
      Tab(4).Control(8)=   "cmdGeneral_DeleteDebugDir(0)"
      ...
      Tab(5).Control(1)=   "Compile_PauseLink"
      Tab(5).Control(1).Enabled=   0   'False
      Tab(5).Control(2)=   "Compile_ModifyCmdLine"
      Tab(5).Control(2).Enabled=   0   'False
      Tab(5).Control(3)=   "Compile_SkipLinking"
      ...
      Tab(6).Control(7)=   "DLL_DebugPreLoader"
      Tab(6).Control(7).Enabled=   0   'False
      Tab(6).Control(8)=   "DLL_FullLoading"
      Tab(6).Control(8).Enabled=   0   'False
      Tab(6).Control(9)=   "DLL_UsePreLoader"
      Tab(6).Control(9).Enabled=   0   'False
      Tab(6).Control(10)=   "cdmDLL_AddDllMain"
      ...
      Begin VB.CheckBox General_PopUpWindow 
         ...
         Width           =   3975
      End
      Begin VB.CheckBox General_UnLoadNotExe 
         Caption         =   "UnLoad if Project is not Standart EXE"
         Height          =   250
         Left            =   240
         TabIndex        =   18
         Top             =   1080
      ...
      Begin VB.CheckBox Debug_OutDebLog 
         ...
         Width           =   2295
      End
      Begin VB.CheckBox Debug_DebMsgBox 
         Caption         =   "Enable debug MsgBox"
         Height          =   375
         Left            =   -74760
         TabIndex        =   4
         Top             =   720
...
Dim sText As String
    ...
    If bUseDefault = True Then
        ...
        LogMsg "Setting Default Settings..." & IIf(eScope = Global_, "Global", "Local"), "frmSettings", "LoadSettings"
    End If
...
Private Sub SaveSettingsToVariables()
    ...
    Let_General UnLoadIfProjectIsNotStandartExe, General_UnLoadNotExe.value
    Let_General PopUpExportsWindow, General_PopUpWindow.value
    Let_General SetTopMost, General_SetTopMost.value
    Let_General ListingsForAllModules, General_ListForAllMod.value
    Let_General SaveObjFiles, General_SaveOBJ.value
    ...
    'Tab Debug
    Let_Debug EnableDebugMsgBox, Debug_DebMsgBox.value
    ...
    Let_Compile SkipLinking, Compile_SkipLinking.value
